  ...
  return (
    <>
      ...
      <div className="mobile-bottom-nav">
        ...
        <div
          className={`nav-icon ${active === "addCustomer" ? "active" : ""}`}
          onClick={() => nav("addCustomer")}
        >
          🤝
        </div>
        <div
          className={`nav-icon ${active === "stockReport" ? "active" : ""}`}
          onClick={() => nav("stockReport")}
        >
          📦
        </div>
        <div
          className={`nav-icon ${active === "generateBill" ? "active" : ""}`}
          onClick={() => nav("generateBill")}
        >
          🧾
        </div>
        {session?.user?.provider === "credentials" && (
          <div
            className={`nav-icon ${active === "changePassword" ? "active" : ""}`}
            onClick={() => nav("changePassword")}
          >
            🔑
          </div>
