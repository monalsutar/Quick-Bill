  ...
  return (
    <div className="app-container">
      ...
      <section className="hero-section">
        <div className="hero-content">
          ...
          <p className="hero-subtitle">
            Simplify your billing, empower your business. Create invoices,
            track payments, and grow revenue effortlessly.
          </p>
      ...
      <section className="features-section">
        ...
        <div className="features-grid">
          <div className="feature-card">
            ...
            <p>
              Generate and send professional invoices in seconds with
          ...
          <div className="feature-card">
            ...
            <p>
              Accept payments securely with integrated gateways and fraud
              protection.
            </p>
          </div>
          ...
          <div className="feature-card">
            ...
            <p>
              Track your product quantity and prices; stock updates automatically
              after each sale.
            </p>
          </div>
          <div className="feature-card">
            ...
            <h3>Admin Panel</h3>
            <p>
              Manage all merchants, view reports, and monitor transactions in
              one place.
            </p>
          </div>
          <div className="feature-card">
            ...
            <p>
              Send invoices to customers directly via email in one click.
            </p>
          </div>
          <div className="feature-card">
            ...
            <p>
              Store and manage customer information with billing history.
            </p>
          </div>
          <div className="feature-card">
      ...
      <footer className="footer">
        <p>
          &copy; 2025 QuickBill. All rights reserved. |{" "}
